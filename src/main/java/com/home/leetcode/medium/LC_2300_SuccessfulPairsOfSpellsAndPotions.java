 ...
 *
 * @see <a href="https://leetcode.cn/problems/successful-pairs-of-spells-and-potions/" />
 * @author Poet
 * @date 2023/11/10
 */
public class LC_2300_SuccessfulPairsOfSpellsAndPotions {
    ...
    @Deprecated
    public int[] successfulPairs_wrong(int[] spells, int[] potions, long success) {
        int n = spells.length;
        int[] res = new int[n];
        for (int i = 0; i < n; i++) {
            int spell = spells[i];
